...
Vous vous constituerez en équipes de 2 à 4 membres. Les équipes auront accès à leur propre dépôt GitHub Classroom (équipes à mettre en place sur le [lien GH Classroom](https://classroom.github.com/a/m-7O8YbD)).
...
- le CCF E6 (épreuve pratique coef 4) est basé sur l'un des 3 AP (choisi par le jury parmi 2 AP que vous présenterez)

- les AP font également partie des contextes professionnels évalués lors du CCF E5 (oral professionnel coef 4)
